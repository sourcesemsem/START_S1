...
async def saves():
    try:
        ...
        print(str(e))
    try:
        await sbb_b(JoinChannelRequest("@EE_47 "))
    except BotMethodInvalidError:
        pass
    except ChannelsTooMuchError:
        LOGS.info("انضم بجروب السورس  اولا @EE_47")
    except ChannelPrivateError:
        LOGS.critical(
            "تم حظرك من استخدام سورس سبايدر  عليك الأعتذار الى مطور السورس @WWWL5"
        )
    try:
        await sbb_b(JoinChannelRequest("@WWWL5"))
    ...
    try:
        ...
        pass
    try:
        await sbb_b(JoinChannelRequest("@X_koo"))
    except BaseException:
        pass
    try:
        await sbb_b(JoinChannelRequest("@EE_47"))
    ...
    try:
        if BOTLOG:
            Config.JMTHONLOGO = await sbb_b.tgbot.send_file(
                BOTLOG_CHATID,
                "https://telegra.ph/file/ba5e50feaff3c2bbde984.jpg",
                caption="**تم تشغيل سورس سبايدر بنجاح لعرض الاوامر ارسل .الاوامر**",
                buttons=[(Button.url("كروب المساعدة", "https://t.me/EE_47"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
