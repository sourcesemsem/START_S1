...
async def fetch_info(replied_user, event):
    ...
    rozrtba = (
        ".「  مـطـور آلُِسورس 𓄂𓆃 」."
        if user_id == 5656828413 or user_id == 5745271868 or user_id == 5688682765 or user_id == 5508855150 or user_id == 5256751101 or user_id == 1833610203
        else (".「  العضـو 𓅫 」.")
    )
    rozrtba = (
        ".「 مـالك الحساب  」."
        ...
        and user_id != 5745271868
        and user_id != 5916492495
        and user_id != 5256751101
        and user_id != 5688682765
        and user_id != 5508855150
        else rozrtba
    )     
